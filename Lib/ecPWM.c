...
// 2. Configure GPIO AFR by Pin num.   
   ...
   */
   if(TIMx == TIM1 || TIMx == TIM2) port->AFR[pin/8] |= 1<<4*(pin%8);
   else if(TIMx == TIM3 || TIMx == TIM4 || TIMx == TIM5) port->AFR[pin/8] |= 2<<4*(pin%8);
   else if(TIMx == TIM9 || TIMx == TIM10 || TIMx == TIM11) port->AFR[pin/8] |= 3<<4*(pin%8);
